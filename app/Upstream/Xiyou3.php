...
class Xiyou3 {
    private $_mchId = 'e81266b873d965ef';
    private $_key = '7f1b3ba126a79e1e8cf00f87aa2a184f';
    ...
    public function order($request) {
        ...
        $parameter['refer'] = config('app.url').'/api/pay/xiyou3/notify';
        $parameter['notify_url'] = config('app.url').'/api/pay/xiyou3/notify';
        $parameter['typec'] = $request['channelId'];
        $parameter['json_ret'] = 1;
        //post请求
        $header =  array('Accept-Language: zh-cn');

        error_log(print_r($parameter,1),3,'xiyou3req.txt');
        ...
        error_log(print_r($result,1),3,'xiyou3req.txt');
