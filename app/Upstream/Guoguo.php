...
class Guoguo {
    private $_mchId = '1518571035765567489';
    private $_key = 'ogqn1n90wsv5klhcks144q29a0ufxgsg';
    private $_url = 'http://45.153.8.203:8888/';
...
//            'device' => 'ios',
            ...
            'notifyUrl' => config('app.url').'/api/pay/guoguo/notify',
        ...
        if(!empty($request['redirectUrl'])) {
            ...
            $parameters['returnUrl'] = config('app.url').'/api/pay/guoguo/notify';
        }
        $signObj = new Sign();
