...
class Sanqian {
    private $_mchId = '1552478666657689601';
    private $_key = 'qete2yricclapqm1ev8sxp17kf0duqtt';
    private $_url = 'http://206.119.73.120:8888/';
...
//            'device' => 'ios',
            ...
            'notifyUrl' => config('app.url').'/api/pay/sanqian/notify',
        ...
        if(!empty($request['redirectUrl'])) {
            ...
            $parameters['returnUrl'] = config('app.url').'/api/pay/sanqian/notify';
        }
        $signObj = new Sign();
