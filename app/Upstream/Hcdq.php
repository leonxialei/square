...
class Hcdq {
    private $_mchId = '5738';
    private $_key = 'a7j0h3r4d7n3l2U0UdWeN8xed0TfEa21N9T1Q9w6M6D6Y6y3O7TaM20dO1D1E3wa';
...
//            'ip' => $request['clientIp'],
            ...
            'otifyUrl' => config('app.url').'/api/pay/hcdq/notify',
        ];
        ...
        if(!empty($request['redirectUrl'])) {
            ...
            $parameters['returnUrl'] = config('app.url').'/api/pay/hcdq/notify';
        }
