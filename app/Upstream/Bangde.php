...
class Bangde {
    private $_mchId = '9bfg93ke';
    private $_key = '802fd1f092bbc167';
    private $_url = 'http://115.126.98.18:12345/';
    public function order($request) {
        ...
        $parameters = [
            ...
            'payip' => $a.'.'.$b.'.'.$c.'.'.$d,
            'notifyurl' => config('app.url').'/api/pay/bangde/notify',
        ...
        if(!empty($request['redirectUrl'])) {
            ...
            $parameters['returnurl'] = config('app.url').'/api/pay/ak/notify';
        }
        $signObj = new Sign();
