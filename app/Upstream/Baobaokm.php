...
class Baobaokm {
    private $_mchId = '2408080713';
    private $_key = 'zpuk8zIG5tYitQRycVKndFfNVXYUsB3BraE2GefX5sBjkYSQq49bwXsqYkIqx75k';
    private $_url = 'http://wxzz.hyhyxt123.com/';
    public function order($request) {
        $parameters = [
            'user_id' => $this->_mchId,
            'money' => sprintf("%.2f", $request['amount']/100),
            'notify_url' => config('app.url').'/api/pay/baobaokm/notify',
            'type' => 1,
            'timestamp' => time(),
