...
class Mu {
    private $_mchId = '10008';
    private $_key = '4JY2AIUQP5ZK9EMJ0SGSKYUG1U998RXQNGLIRNSTDNQOLSQOBPVRFMIID2U6GGVQ0PNIY6B17HYDWOCMJNNLJ9ZGICS94RVDS4ZFYWP8LYBNLZKE5YMGJBE34TUGZX0H';
    private $_url = 'http://pay.qiji.one/';
    public function order($request) {
        $parameters = [
            ...
            'notifyUrl' => config('app.url').'/api/pay/mu/notify',
