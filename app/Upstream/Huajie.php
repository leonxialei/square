...
class Huajie {
    private $_mchId = '2022152';
    private $_key = 'zdLsyXAovCjRZqHLONTZPLtkxsdnHFYd';
    private $_url = 'http://huajie.8456852.com/';
    public function order($request) {
        $parameters = [
            ...
            'fxnotifyurl' => config('app.url').'/api/pay/huajie/notify',
