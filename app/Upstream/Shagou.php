...
class Shagou {
    private $_mchId = '2210235606';
    private $_key = '2b16c5a102723f2d413e4eab50913ae4';
    private $_url = 'http://2210235606.m.dxton.cn/';
    public function order($request) {
        $parameters = [
            ...
            'return_url' => config('app.url').'/api/pay/shagou/notify',
        ...
        if(!empty($request['redirectUrl'])) {
            ...
            $parameters['notify_url'] = config('app.url').'/api/pay/shagou/notify';
        }
