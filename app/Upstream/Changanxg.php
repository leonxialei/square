...
class Changanxg {
    private $_mchId = '201597';
    private $_key = '3168475E24004FAE91647EC4B6908B8C';
    ...
    public function order($request) {
        $parameters = [
            ...
            'notify_url' => config('app.url').'/api/pay/changanxg/notify',
    ...
    public function notify($request) {
        ...
        error_log(print_r($json,1),3,'xingreq.txt');
