...
class Huixin {
    private $_mchId = '1549031086732931074';
    private $_key = '6uby6h3fneb8l35wlbeykr85zsgkkyl7';
    private $_url = 'http://206.119.75.186:8888/';
...
//            'device' => 'ios',
            ...
            'notifyUrl' => config('app.url').'/api/pay/huixin/notify',
        ...
        if(!empty($request['redirectUrl'])) {
            ...
            $parameters['returnUrl'] = config('app.url').'/api/pay/huixin/notify';
        }
        $signObj = new Sign();
