...
class Konglong {
    private $_mchId = '1528633730883710978';
    private $_key = '4nyslnpky462q1aidpuidxyp71eigf7j';
    private $_url = 'http://206.119.65.57:8888/';
...
//            'device' => 'ios',
            ...
            'notifyUrl' => config('app.url').'/api/pay/konglong/notify',
        ...
        if(!empty($request['redirectUrl'])) {
            ...
            $parameters['returnUrl'] = config('app.url').'/api/pay/konglong/notify';
        }
        $signObj = new Sign();
