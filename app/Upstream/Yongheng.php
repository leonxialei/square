...
class Yongheng {
    private $_mchId = '1054';
    private $_key = '8338e72e03bd4437b5777b0f35326509';
    private $_url = 'http://137.220.176.113:16667/';
    public function order($request) {
        $parameters = [
            ...
            'notify_url' => config('app.url').'/api/pay/yongheng/notify',
        ...
        if(!empty($request['redirectUrl'])) {
            ...
            $parameters['return_url'] = config('app.url').'/api/pay/yongheng/notify';
        }
        $signObj = new Sign();
