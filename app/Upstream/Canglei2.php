...
class Canglei2 {
    private $_mchId = '10007';
    private $_key = '2241929f8321b41af93ad445d55052d9';
    private $_url = 'http://thunder.2000000000.vip/';
    public function order($request) {
        $parameters = [
            ...
            'notifyUrl' => config('app.url').'/api/pay/canglei2/notify',
