...
class Wubai {
    private $_mchId = '1081';
    private $_key = 'b0b7cae9580b485b8b88183f82938ea0';
    private $_url = 'http://137.220.137.225:8888/';
    public function order($request) {
        $parameters = [
            ...
            'notify_url' => config('app.url').'/api/pay/wubai/notify',
        ...
        if(!empty($request['redirectUrl'])) {
            ...
            $parameters['return_url'] = config('app.url').'/api/pay/wubai/notify';
        }
        $signObj = new Sign();
