...
class Xiyou2 {
    private $_mchId = '8568111';
    private $_key = '0FACD02D9B1FD6FEC9D4DA22E1599071';
    ...
    public function order($request) {
        ...
        $parameter = array(
            ...
            "notify_url" =>config('app.url').'/api/pay/xiyou2/notify',
            "return_url" =>config('app.url').'/api/pay/xiyou2/notify',
        );
        ksort($parameter);
        reset($parameter);
        $fieldString = [];
