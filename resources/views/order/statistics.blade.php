...
<div class="layuimini-container">
    <div class="layuimini-main">
        <div style="margin: 10px 10px 10px 10px" class="layui-card-header"><i class="fa fa-warning icon"></i>分析
            <span mark="0" style="cursor:pointer;" class="layui-card-heade-such">查询</span>
        </div>
