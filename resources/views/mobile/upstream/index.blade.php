...
<div class="layuimini-container">
    <div class="layuimini-main">
        <div style="margin: 10px 10px 10px 10px" class="layui-card-header"><i class="fa fa-warning icon"></i>通道分配</div>
        <fieldset class="table-search-fieldset">

            <div style="margin: 10px 10px 10px 10px">

                    <div class="layui-inline" style="margin-bottom: 3px;font-size: 10px;">
...
{{--                        <th>{{$merchantChannel->amount}}</th>--}}
                        ...
                        <th><button type="button" onclick="edit_code({{$merchantChannel->id}})" class="layui-btn layui-btn-warm layui-btn-xs">修改</button></th>
