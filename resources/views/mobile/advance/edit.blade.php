...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <form class="layui-form" method="post" action="{{secure_url('advance')}}/{{$merchant->id}}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text"  name="merchant" value="{{$merchant->name}}"  autocomplete="off" class="layui-input layui-disabled">
                </div>
            ...
            <div class="layui-form-item">
                <div class="layui">
                    <label class="layui-form-label">预付剩余</label>
                    <div class="layui-input-block">
                        <input type="text"  name="balance" value="{{$merchant->balance}}"  autocomplete="off" class="layui-input layui-disabled">
                    </div>
                </div>
