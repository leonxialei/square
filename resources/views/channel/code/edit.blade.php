...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <form class="layui-form" method="post" action="{{secure_url('channel/code')}}/{{$code->id}}">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">通道编码</label>
                    <div class="layui-input-inline">
                        <input value="{{$code->code}}" type="number" name="code" lay-verify="required|number" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input value="{{$code->name}}" type="text" name="name" lay-verify="required" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
